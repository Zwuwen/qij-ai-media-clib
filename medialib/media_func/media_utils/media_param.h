...
typedef struct _MpiDecLoopData{
    _MpiDecLoopData()
    {
        this->mpi = NULL;
        buf = NULL;
...
typedef struct _rk1808_flow_param
{
    _rk1808_flow_param()
    {
        this->m_buffer = NULL;
...
//ffmpeg 拉流参数数据结构
typedef struct _ffmpeg_pull_flow_param
{
     //ffmpeg
    _ffmpeg_pull_flow_param()
    {
        this->m_id = "";        //拉流参数ID
